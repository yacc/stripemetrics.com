...
describe SdeImport do
  ...
  describe "should create" do
    ...
    it "11 objects from api (in default chunk size of 10 using 2 imports)", :vcr do
      lambda {
    ...
    it "11 objects from api (in default chunk size of 3 using 4 imports)", :vcr do
      lambda {
